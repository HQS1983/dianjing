...
//	})
    //循环  成员管理
    function management(){
    	var html="",html2="",html3="",html4="",html5="",post="";
				...
				for(var i=1; i<=8; i++ ){
					...
					html2 += '<div class="game">'+
								'<a class="fix" href="personal.html">'+
									...
									'<p class="name apostrophe">SIfY4Vx4</p>'+
									'<p class="position">'+post+'</p>'+
								'</a>'+
								html3+
							'</div>';
				}
				html += '<div class="swiper-slide">'+html2+'</div>';
			} else if (QQ==1) {
				post="队员";
				html3='<button type="button" class="buttonManage">管理</button>';
				for(var ii=1; ii<=8; ii++ ){
					html3 += '<div class="game">'+
								'<a class="fix" href="personal.html">'+
									'<img src="img/edg/captain'+ii+'.png">'+
									'<p class="name apostrophe">'+ii+'SIfY4Vx4</p>'+
									'<p class="position">'+post+'</p>'+
								'</a>'+
								html3+
							'</div>';
				}
				html += '<div class="swiper-slide">'+html3+'</div>';
			} else if (QQ==2) {
				post="队员";
				html3='<button type="button" class="buttonManage">管理</button>';
				for(var ii=1; ii<=8; ii++ ){
